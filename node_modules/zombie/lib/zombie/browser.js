var Browser, EventLoop, History, WindowContext, html, jsdom, vm;
...
Browser = (function() {
  ...
  function Browser(options) {
    var Screen, TEXT_TYPES, cache, cookies, findOption, interact, k, mouseEventNames, resources, setCheckbox, storage, v, window, ws, xhr;
    ...
    this.open = function(features) {
      var context, history, newWindow, _ref;
      if (features == null) {
        features = {};
      }
      (_ref = features.interactive) != null ? _ref : features.interactive = true;
      history = features.history || new History(this);
      newWindow = jsdom.createWindow(html);
      context = new WindowContext(newWindow);
      newWindow._evaluate = function(code, filename) {
      ...
      newWindow.__defineGetter__("browser", __bind(function() {
        return this;
      }, this));
      newWindow.__defineGetter__("title", __bind(function() {
        var _ref, _ref2;
        return (_ref = this.window) != null ? (_ref2 = _ref.document) != null ? _ref2.title : void 0 : void 0;
      }, this));
      newWindow.__defineSetter__("title", __bind(function(title) {
        var _ref, _ref2;
        return (_ref = this.window) != null ? (_ref2 = _ref.document) != null ? _ref2.title = title : void 0 : void 0;
      }, this));
      newWindow.navigator.userAgent = this.userAgent;
      ...
      newWindow.JSON = JSON;
      newWindow.onerror = __bind(function(event) {
    ...
    this.__defineGetter__("statusCode", function() {
      var _ref, _ref2;
      return (_ref = this.window.resources.first) != null ? (_ref2 = _ref.response) != null ? _ref2.statusCode : void 0 : void 0;
    });
    this.__defineGetter__("redirected", function() {
      var _ref, _ref2;
      return (_ref = this.window.resources.first) != null ? (_ref2 = _ref.response) != null ? _ref2.redirected : void 0 : void 0;
    });
    this.__defineGetter__("source", __bind(function() {
      var _ref, _ref2;
      return (_ref = this.window.resources.first) != null ? (_ref2 = _ref.response) != null ? _ref2.body : void 0 : void 0;
    }, this));
    ...
    this.saveHistory = function() {
      return window.history.save();
    };
    this.loadHistory = function(serialized) {
      return window.history.load(serialized);
    };
    ...
    this.selectOption = function(option) {
      ...
      if (option && !option.selected) {
        ...
        this.fire("beforeactivate", select);
        option.selected = true;
        this.fire("beforedeactivate", select);
    ...
    this.loadCookies = function(serialized) {
      return cookies.load(serialized);
    };
    ...
    this.loadStorage = function(serialized) {
      return storage.load(serialized);
    };
    ...
    this.__defineGetter__("lastRequest", function() {
      var _ref;
      return (_ref = this.window.resources.last) != null ? _ref.request : void 0;
    });
    this.__defineGetter__("lastResponse", function() {
      var _ref;
      return (_ref = this.window.resources.last) != null ? _ref.response : void 0;
    });
    this.__defineGetter__("lastError", function() {
      var _ref;
      return (_ref = this.window.resources.last) != null ? _ref.error : void 0;
    });
    this.log = function() {
